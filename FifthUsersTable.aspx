<%@ Page Title="" Language="C#" MasterPageFile="~/SWCharactersmp.Master" AutoEventWireup="true" CodeBehind="FifthUsersTable.aspx.cs" Inherits="StarWarsCharactersmp.FifthUsersTable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="text-align:center; z-index:0; position: absolute; bottom: 160px; left: 200px; right: 200px; font-size: 23px">
          <ul id="menu">
