<%@ Page Title="" Language="C#" MasterPageFile="~/SWCharactersmp.Master" AutoEventWireup="true" CodeBehind="SeventhUsersTable.aspx.cs" Inherits="StarWarsCharactersmp.SeventhUsersTable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="text-align:center; position: absolute; bottom: 160px; left: 200px; right: 200px; font-size: 23px">
          <ul id="menu">
