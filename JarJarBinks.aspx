<%@ Page Title="" Language="C#" MasterPageFile="~/SWCharactersmp.Master" AutoEventWireup="true" CodeBehind="JarJarBinks.aspx.cs" Inherits="StarWarsCharactersmp.JarJarBinks" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <h2 style="text-align: center; text-decoration: underline; ">Jar Jar Binks:</h2>
        <br />
            ...
            <div style="text-align: center;">
                <img src="Images/JarJar1.jpg" width="400" height="300"/>
                <img src="Images/JarJar2.jpg" width="400" height="300"/>
                <img src="Images/JarJar3.jpg" width="400" height="300"/>
            </div>
</asp:Content>
