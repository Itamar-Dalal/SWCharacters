<%@ Page Title="" Language="C#" MasterPageFile="~/SWCharactersmp.Master" AutoEventWireup="true" CodeBehind="5SWCharacters.aspx.cs" Inherits="StarWarsCharactersmp._5SWCharacters" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="row" style="text-align: center;">
                <ul id="menu" style="font-size:23px">
                    <li><a href="#Baby Yoda">Baby Yoda</a></li>
                    <li><a href="#Darth Vader">Darth Vader</a></li>
                    <li><a href="#Obi Own Kenobi">Obi-Own Kenobi</a></li>
                    <li><a href="#Palpatine">Palptine (Darth Sidious)</a></li>
                    <li><a href="#Jar Jar">Jar Jar Binks</a></li>
                </ul>
                <br />
                <h2 id="Baby Yoda" style="text-align: center; text-decoration: underline; ">Baby Yoda:</h2>
                <p>
                    ...
                    <br />
                    <center>
                        <img src="Images/BabyYoda.png" width="400" />
                    </center>
                    <a href="BabyYoda.aspx"><center>Read more on Baby Yoda</center></a>
                </p>
                <hr style="border-top: 3px solid #fcd000"/>
                <h2 id="Darth Vader" style="text-align: center; text-decoration: underline; ">Darth Vader:</h2>
                <p>
                    Anakin Skywalker, more commonly known by his alias Darth Vader is a fictional character in the Star Wars franchise. The character is the central antagonist of the original trilogy and, as Anakin Skywalker, is one of the main protagonists throughout the prequel trilogy. Star Wars creator George Lucas has collectively referred to the first six episodic films of the franchise as "the tragedy of Darth Vader". He has become one of the most iconic villains in popular culture, and has been listed among the greatest villains and fictional characters ever.
                    <br />
                    <center>
                        <img src="Images/DarthVader.png" width="400" />
                    </center>
                    <a href="DarthVader.aspx"><center>Read more on Darth Vader</center></a>
                </p>
                <hr style="border-top: 3px solid #fcd000"/>
                <h2 id="Obi Own Kenobi" style="text-align: center; text-decoration: underline; ">Obi-Own Kenobi:</h2>
                <p>
                ...
                <p>
                    ...
                    <br />
                    <center>
                        <img src="Images/JarJar.png" width="400" />

                    </center>
                    <a href="JarJarBinks.aspx"><center>Read more on Jar Jar Binks</center></a>
                </p>
    </div>
</asp:Content>
